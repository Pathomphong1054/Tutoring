...
class _StudentProfileScreenState extends State<StudentProfileScreen> {
  ...
  Future<void> _fetchProfileData() async {
    ...
    try {
      final url = Uri.parse(
          'http://10.5.50.84/tutoring_app/get_student_profile.php?username=${widget.userName}');
  ...
  Future<void> _uploadProfileImage(File imageFile) async {
    try {
      var request = http.MultipartRequest(
        'POST',
        Uri.parse('http://10.5.50.84/tutoring_app/upload_profile_student.php'),
      );
    ...
    if (_profileImage != null) {
      ...
      try {
        var response = await http.post(
          Uri.parse(
              'http://10.5.50.84/tutoring_app/update_student_profile.php'),
          body: {
